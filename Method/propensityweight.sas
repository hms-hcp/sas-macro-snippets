...
%macro propensityweight(datain,treatmn,outcomes,predprb,dtmodel,dataout,vlist,listnum,
          libout=out.,libin=);
...
ods trace on;
     ...
     by &treatmn;
     title "Propensity score weighting: overlap";
     run;
     ...
     proc surveymeans data=&libout&dataout ;
     var &outcomes;
     weight  horvitzweight;
     by &treatmn;
     title "Propensity score weighting: Horvitz-Thomson";
     run;
...
proc print data=_statsm;
     title "Propensity scoreweighting: overlap";
run;

proc print data=_statsm1;
     title "Propensity scoreweighting: Horvitz-Thomson";
     run;

%mend propensityweight;
